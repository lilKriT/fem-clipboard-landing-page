    ...
    <footer className="w-full flex justify-center items-center bg-gray-50 mt-32">
      <div className="w-full max-w-7xl flex flex-col md:flex-row justify-center items-center mx-8 my-12 gap-8">
        ...
        <div className="flex justify-center items-center gap-4 md:ml-auto">
          {/* Facebook Logo */}
          <Link href={"/#"} aria-label="Clipboard Facebook Profile">
            <svg
              height={30}
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
              className="text-gray-700 fill-current hover:text-green-500 motion-safe:duration-150 ease-in-out"
            >
          ...
          {/* Twitter Logo */}
          <Link href={"/#"} aria-label="Clipboard Twitter Profile">
            <svg
              height={30}
              viewBox="0 0 24 20"
              xmlns="http://www.w3.org/2000/svg"
          ...
          {/* Instagram Logo */}
          <Link href={"/#"} aria-label="Clipboard Instagram Profile">
            <svg
              height={30}
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
